...
- [x] **DQ-05**: Cleanup retroattivo dei dati esistenti in produzione che violano i nuovi filtri
...
- [x] **UI-07**: Mesh gradients su hero section e sfondi pagina per profondità visiva
- [x] **UI-08**: Componenti chiave (SagraCard, Hero, pagine) ridisegnati con estetica moderna
