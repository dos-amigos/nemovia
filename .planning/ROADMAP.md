...
- [x] **Phase 2: Scraping Pipeline** - Config-driven scraper collecting sagre from 5+ sources with dedup, scheduling, and expiration (completed 2026-03-04)
...
**Success Criteria** (what must be TRUE):
  1. Running the scraper populates the database with sagre from at least 5 distinct sources (SoloSagre, EventieSagre, Sagritaly, AsseSagre, VenetoInFesta)
...
Plans:
- [x] 02-01-PLAN.md -- Vitest setup + scraper helper library (normalizeText, parseItalianDateRange, types) with unit tests
- [x] 02-02-PLAN.md -- Database migration: scraper_sources, scrape_logs tables; sagre alterations; normalize_text() function; find_duplicate_sagra() RPC; pg_cron schedules; seed data
- [x] 02-03-PLAN.md -- Edge Function scrape-sagre: orchestrator with Cheerio HTML scraping, deduplication, upsert, failure tracking
- [x] 02-04-PLAN.md -- Verify pg_cron scheduling, expire logic, end-to-end pipeline confirmation
